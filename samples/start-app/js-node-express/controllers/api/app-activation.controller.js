const { appActivate, appCallback, notifyAuthorizationUpdate } = require('../../use-cases/app-activation');
...
module.exports = {
    ...
    notifyAuthorizationUpdate: (req, res, next) => notifyAuthorizationUpdate({req, res, next})
};
